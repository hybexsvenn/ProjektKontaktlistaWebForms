...
<body style="width: 1151px; height: 608px">
            ...
            <asp:Panel ID="address_panel" runat="server" Visible="False">
                ...
                <table class="auto-style10">
                    <tr>
                        <td class="auto-style12">Type:</td>
                        <td>
                            <asp:DropDownList ID="type_phone" runat="server" Height="16px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Width="164px">
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="type_phone_error" runat="server" ControlToValidate="type_phone" ErrorMessage="Choose phone type" ForeColor="Red" InitialValue="Select address" ValidationGroup="a3"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
